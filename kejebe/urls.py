...
api_patterns = [
    ...
    path("legal/terms", TermsInfoView.as_view(), name="legal-terms"),
    path("legal/terms/", TermsInfoView.as_view(), name="legal-terms-slash"),
...
urlpatterns = [
    ...
    path("terms-of-use/", terms_of_use_view, name="terms-of-use-slash"),
    path("privacy-policy", privacy_policy_view, name="privacy-policy"),
    path("privacy-policy/", privacy_policy_view, name="privacy-policy-slash"),
