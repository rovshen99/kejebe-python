...
MINIO_PUBLIC="${MINIO_PUBLIC:-true}"
MINIO_REGION="${MINIO_REGION:-us-east-1}"
MINIO_ADDRESSING_STYLE="${MINIO_ADDRESSING_STYLE:-path}"

SMS_SERVICE_NUMBER="${SMS_SERVICE_NUMBER:-+99361111111}"
...
SMS_INBOUND_API_KEY=${SMS_INBOUND_API_KEY:-}
SMS_SERVICE_NUMBER=${SMS_SERVICE_NUMBER}
...
MINIO_PUBLIC=${MINIO_PUBLIC}
MINIO_REGION=${MINIO_REGION}
MINIO_ADDRESSING_STYLE=${MINIO_ADDRESSING_STYLE}
